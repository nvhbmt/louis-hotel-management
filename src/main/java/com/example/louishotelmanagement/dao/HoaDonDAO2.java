...
public class HoaDonDAO2 {
    ...
    // 2. TÌM HÓA ĐƠN THEO MÃ (Đã bổ sung và sửa lỗi tên cột)
    ...
    // 4. LẤY CHI TIẾT DỊCH VỤ/PHÒNG (Gọi từ HoaDonDAO)
    public List<HoaDonChiTietItem> layChiTietHoaDon(String maHD) throws SQLException {
        return new HoaDonDAO().layChiTietHoaDon(maHD);
    }

    // --- CÁC HÀM HELPER ĐỂ ĐỌC DỮ LIỆU AN TOÀN ---
