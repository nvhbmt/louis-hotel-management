...
import com.example.louishotelmanagement.controller.QuanLyThanhToanController;
...
public class QuanLyHoaDonView {
  ...
  private Parent root;
  public QuanLyThanhToanController quanLyThanhToanController;
  ...
  public QuanLyHoaDonView() {
    ...
    this.quanLyThanhToanController = new QuanLyThanhToanController(this);
  }
