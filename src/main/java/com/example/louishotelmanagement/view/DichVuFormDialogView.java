...
public class DichVuFormDialogView {
    ...
    public DichVuFormDialogView() {
        BorderPane borderpane1 = new BorderPane();
        borderpane1.setPrefHeight(202.0);
        borderpane1.setPrefWidth(679.0);
        ...
        lblTieuDe = new Label("Thêm Dịch Vụ Mới");
        lblTieuDe.getStyleClass().addAll("dialog-title");
        Label label1 = new Label("Nhập thông tin dịch vụ");
    ...
    public Button getBtnHuy() { return btnHuy; } // Getter mới bổ sung
}